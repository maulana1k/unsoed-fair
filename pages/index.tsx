      ...
      <div id="__next" className="h-full bg-violet-700">
        <main>
              ...
              <div className="z-10">
                <div className="flex flex-col items-center gap-[60px] lg:flex-col">
                  <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white text-center">
                    Biarkan 450+ Perusahaan Mengajak Anda Bergabung
                  </h1>
                  <p className="mb-6 text-lg font-normal text-white lg:text-xl sm:px-16 xl:px-48 dark:text-white text-center">
                    UnsoedFair adalah sebuah website yang bertujuan untuk membantu para mahasiswa Universitas Jenderal
                    Soedirman baik yang aktif untuk mencari tempat magang ataupun yang sudah lulus untuk mencari tempat
                    kerja.
                  </p>
                  <a
                    href="/try-now"
                    className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 content-center"
                  >
                    Get Started
                  </a>
                </div>
          ...
          <section className="py-[60px] lg:py-[120px] bg-white relative">
            <div className="flex flex-col items-center gap-[60px] lg:flex-col">
              <h2 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-slate-600 md:text-5xl lg:text-6xl dark:text-slate-800 text-center">
                Bekerja Sama Dengan <span className="text-blue-600 dark:text-blue-500">450+ Perusahaan</span> Di Seluruh
                Dunia
              </h2>
            </div>
          </section>
          <section className='relative z-[5] bg-tertiary-violet-50 py-[60px] lg:pt-[156px] lg:pb-[188px]"'>
            ...
            <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-[42.5px] mt-6 lg:mt-10 animate-scrolled--fadeIn animated">
              <div className="rounded-xl p-5 lg:px-[21px] lg:pb-[43px] lg:pt-9 relative border max-w-[336px] mx-auto border-neutral-100 bg-white inline-block w-full text-center">
                ...
                <p className="text-xs lg:text-base font-bold text-slate-500 !leading-[1.3] mt-3 lg:mt-6">
                  Masukkan CV anda
                </p>
                <p className="text-xs lg:text-sm text-neutral-80 !leading-[1.3] mt-1 lg:mt-2">
                  Hanya dengan beberapa menit, CV anda bisa selalu di-update.
                </p>
              </div>
              <div className="rounded-xl p-5 lg:px-[21px] lg:pb-[43px] lg:pt-9 relative border max-w-[336px] mx-auto border-neutral-100 bg-white inline-block w-full text-center">
                ...
                <p className="text-xs lg:text-sm text-neutral-80 !leading-[1.3] mt-1 lg:mt-2">
                  Dengan teknologi kami dapat menganalisis pekerjaan yang sekiranya tepat berdasarkan CV anda.
                </p>
              </div>
              <div className="rounded-xl p-5 lg:px-[21px] lg:pb-[43px] lg:pt-9 relative border max-w-[336px] mx-auto border-neutral-100 bg-white inline-block w-full text-center">
                ...
                <p className="text-xs lg:text-base font-bold text-slate-500 !leading-[1.3] mt-3 lg:mt-6">
                  Duduk Manis dan Tunggu Tawaran
                </p>
                <p className="text-xs lg:text-sm text-neutral-80 !leading-[1.3] mt-1 lg:mt-2">
                  Ribuan perekrut sudah siap untuk menerima anda dengan penawaran yang menarik untuk setiap para
                  rekruter.
                </p>
              </div>
            </div>
          ...
          <footer className="bg-[#27125C] content-center">
            <div className="lg:w-[353px]">
              ...
              <span className="mt-4 block text-xs leading-[1.3] text-white md:text-[13px]">
                Daftar dan dapatkan penawaran dari berbagai perusahaan
              </span>
