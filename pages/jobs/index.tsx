      ...
      <div className="h-full bg-violet-700">
        ...
        >
          <div className="flex space-x-8">
            <Link href="/jobs" className={`text-white text-2xl font-bold`}>
        ...
        <div className="bg-white rounded-t-[0px] mt-8 p-6 min-h-full">
          <div className="max-w-[1200px] mx-auto space-y-6 ">
            <div className="flex space-x-6">
              <Link
                href="/jobs"
                style={{ fontWeight: Router.pathname === '/jobs' ? 'bold' : 'normal' }}
                className={`text-lg text-gray-500 font-medium  py-2 cursor-pointer ${
                  Router.pathname === '/jobs' ? 'border-b-2 text-slate-800 border-slate-800' : ''
                }`}
              >
                Explore
              </Link>
              <Link
                href="/jobs/saved"
                style={{ fontWeight: Router.pathname === '/jobs/saved' ? 'bold' : 'normal' }}
                className={`text-lg text-gray-500 font-medium  py-2 cursor-pointer ${
                  Router.pathname === '/jobs/saved' ? 'border-b-2 text-slate-800 border-slate-800' : ''
                }`}
              >
                Saved
              </Link>
